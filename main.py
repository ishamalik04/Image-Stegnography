...
image_icon=PhotoImage(file="cyber4.png")
root.iconphoto(False,image_icon)

logo=PhotoImage(file="cyber4.1.png")
Label(root,image=logo,bg='#2f4155').place(x=10,y=2)

Label(root,text="CYBER SCIENCE",bg='#2d4155',fg="white",font="arial 30 bold").place(x=120,y=20)
